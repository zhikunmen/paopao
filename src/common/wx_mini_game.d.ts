...
declare const wx: {
     ...
     */
    onAccelerometerChange(callback: (res: any) => void): void;
     ...
     * 主动拉起转发，进入选择通讯录界面。
     */
    shareAppMessage(object: { title?: string, imageUrl?: string, query?: string, cancel?: Function}): void;
    ...
    navigateToMiniProgram(object: any): any;
    /**
     * 创建意见
     */
